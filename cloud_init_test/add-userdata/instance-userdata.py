...
image = nova.images.find(id="25f18f69-beeb-4948-89aa-0c1843971d7c")
...
secgroup = nova.security_groups.find(name="majae_sec")
...
instance = nova.servers.create(name="majae_dist", image=image, flavor=flavor, userdata=userdata, key_name="majae_keypair_2", nics=nics,security_groups=secgroups)
