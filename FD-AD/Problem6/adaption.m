...
function [X_adapted,M]=adaption(A,X_vals,vector_lengths,h_fine,saved_sols,no_of_sols,r,sigma1,sigma2,rho,space_tol,space_fac,max_length)
...
for ii= 1:No_dims % Loop over the dimensions
  ...
  [A,h2tmp1,h2tmp2]=generatematrix(X_new,vector_lengths_new(1),vector_lengths_new(2),sigma1,sigma2,rho,r); 
...
%  vec_length_adapted=[vec_length_adapted length(S_new)];
