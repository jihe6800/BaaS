...
function [Delta]=BSeuCallDeltaI_FDA(S0,K,T,r,sigma)
...
[soldg_adapted(2:M-1),saved_sols] = dgdec_direct(A_adapted,Smax,K,r,p0_adapted(2:M-1),dt,timesteps,1,no_of_sols);
 ...
 Delta = (interp1(S_adapted(2:M-1),soldg_adapted(2:M-1)',S0+h,'spline')-interp1(S_adapted(2:M-1),soldg_adapted(2:M-1)',S0-h,'spline'))/(2*h);
