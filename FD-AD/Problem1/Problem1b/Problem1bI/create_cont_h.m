...
% Calculate the 'continuous' h_function as
% h(x) = min { h_0*sqrt( tol/ (factor*tol +0.25* Tau_star)) , 0 }
% where Tau_star is the weighted average of the three closest Tau's!
